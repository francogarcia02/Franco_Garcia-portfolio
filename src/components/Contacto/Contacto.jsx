...
const Contacto = () => {
    return(
        <section id="Contacto" className="space grid-default">
            <h1 className="display-3 text-primary mb-3 mt-5 font-game">CONTACTO</h1>
            <div className="d-grid">
                <div className="d-flex flex-wrap align-items-center mb-2">
                    <Whatsapp className="text-light me-1"/>
                    <p className="text-light m-0 me-1">Whatsapp</p>
                    <a className="text-green" href="https://wa.me/3512290552">+54 9 351 229 0552</a>
                </div>
                <div className="d-flex flex-wrap align-items-center mb-2">
                ...
                <div className="d-flex flex-wrap align-items-center mb-2">
                    ...
                    <a className="text-green" href="mailto:francoalbertogarcia2017@gmail.com">francoalbertogarcia2017@gmail.com</a>
                </div>
            </div>
            <div className="mt-2 grid-default">
